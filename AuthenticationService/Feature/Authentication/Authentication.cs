...
public struct LoginResponse
{
    ...
    public UserCredentials.UserCredentials? User { get; set; }
...
/// Is a request that is sent to the associated controller when the <see cref="UserCredentials"/> forgot his password with his email included.
/// </summary>
...
/// Is a request that is sent to the associated controller when the <see cref="UserCredentials"/> resets his password with the token, email and new password included.
/// </summary>
